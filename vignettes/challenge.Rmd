...
The MR Data Challenge is an opportunity to explore and develop innovative approaches to causal inference. In this session we have included summary data on metabolites from Kettunen et al (@Kettunen1), with further data publicly available for download from [Computational Medicine](http://www.computationalmedicine.fi/data#NMR_GWAS).
